...
-- نفّذ هذا الكود مرة واحدة في محرر SQL في Supabase قبل استخدام الميزة.
-- ============================================================
...
-- نفذتش n8n/START_LESSON_DB_NOTE.sql من قبل)، نفّذ الكود ده الأول:
--
-- ALTER TABLE teachers_manager.lessons
--     ADD COLUMN IF NOT EXISTS status text NOT NULL DEFAULT 'completed';
--
-- وبعدها نفّذ القيد (CONSTRAINT) اللي فوق.
-- ============================================================
--
