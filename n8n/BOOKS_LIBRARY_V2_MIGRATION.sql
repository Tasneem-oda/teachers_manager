...
--
-- شغّل الملف ده مرة واحدة في Supabase → SQL Editor (بعد ما تكون نفّذت
-- BOOKS_LIBRARY_DB_MIGRATION.sql القديم). كله آمن للتكرار (idempotent):
-- لو نفّذته مرتين مفيش أي ضرر.
-- ============================================================
...
--   لو غيّرت الموديل أو الحجم مستقبلًا لازم تغيّره في ask-sources و book-index و prepare-lesson
--   وتغيّر vector(768) وتعيد فهرسة كل الكتب.
-- * لو عايز تغيّر الحد اليومي للـ OCR: عدّل المتغير dailyOcrPages في node
