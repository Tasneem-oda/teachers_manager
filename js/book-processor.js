...
import { normalizeText, assessTextQuality, chunkUnits, paginateBlocks } from './book-chunker.js?v=6';
import { loadPdfJs, pdfDocumentParams, loadJsZip } from './book-libs.js?v=6';
