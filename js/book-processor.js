...
import { normalizeText, assessTextQuality, chunkUnits, paginateBlocks } from './book-chunker.js?v=12';
import { loadPdfJs, pdfDocumentParams, loadJsZip, repairPdfBytes } from './book-libs.js?v=12';
