...
import { loadPdfJs, pdfDocumentParams, loadDocxPreview, loadPptxPreview, loadJsZip, loadStyle, CDN, repairPdfBytes } from './book-libs.js?v=10';
import { detectDir } from './book-chunker.js?v=10';
import { BookChat } from './book-chat.js?v=10';
