...
import { loadPdfJs, pdfDocumentParams, loadDocxPreview, loadPptxPreview, loadJsZip, loadStyle, CDN, repairPdfBytes } from './book-libs.js?v=12';
import { detectDir } from './book-chunker.js?v=12';
import { BookChat } from './book-chat.js?v=12';
